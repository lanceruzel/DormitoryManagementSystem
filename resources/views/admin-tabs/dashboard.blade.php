                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Residents</span>
                ...
                <div class="col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Available Rooms</span>
                            ...
                            <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                    <div class="card-title">
                                        <h5 class="text-nowrap mb-2">This month sales</h5>
        ...
        <div class="col-md-6 col-lg-4 order-1 mb-4">
            <div class="card overflow-hidden" style="max-height: 500px; height: 500px">
                <div class="card-header">
                    <h5 class="card-title m-0 me-2">Recent Maintenance Requests</h5>
                </div>
                <div class="card-body ps ps--active-y vertical" id="vertical-1">
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                    <small class="text-muted d-block mb-1">Room 303 <span>(Pending)</span></small>
                                    <h6 class="mb-0">Electrical</h6>
                                </div>
                                <div class="user-progress d-flex align-items-center gap-1">
                                    <h6 class="mb-0">January 1,2024</h6>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 432px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 25px;"></div></div>
                </div>
            </div>
        </div>
        <!--/ Maintenance Request -->
